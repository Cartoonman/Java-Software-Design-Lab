...
public class Simulation {
	...
	// These instance variables are used to hold important information that will be 
	// used in both Simulation and Histogram.
	...
	public int[] makeBins(ArrayList<Double> array, int n){
		// Here we are initializing our variables to make bins, as well as to store for use in Histogram
		bins = n;
	...
	// These getter methods below are specifically for Histogram. They are defined without modifiers, so they are visible to classes in the package but not to classes outside of it. They allow access to the private instance values.
	double getMin(){return min;} // Gets the min value 
	double getRange(){return range;} // Gets the range
	int getBinCount(){return bins;} // gets the bins
	int[] getBins(){return binArray;}  // gets the binArray
}
